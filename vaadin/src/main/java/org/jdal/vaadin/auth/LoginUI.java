...
/**
 * Default login UI for Spring Security
 * 
...
@UiMapping("/login")
@PreserveOnRefresh
public class LoginUI extends UI implements AuthenticationListener {
	...
	protected void init(VaadinRequest request) {
		...
		this.setContent(loginView.getPanel());
	}
	
	@Override
	public void handleAuthentication(AuthenticationEvent event) {
		getPage().setLocation(getApplicationUrl());
	}
	 ...
	 * @return the view
	 */
	public VaadinView<Credentials> getLoginView() {
		return loginView;
	}
