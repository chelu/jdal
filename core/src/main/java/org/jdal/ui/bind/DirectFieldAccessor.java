 ...
 *
 * Note: This class was copied from spring framework for use in AbstractView until 
 * SPR-8389 become fixed and released.<strong>  Don't use it, it will be deleted soon</strong>
 * 
 *
...
public class DirectFieldAccessor extends AbstractPropertyAccessor {
	...
	private final TypeConverter typeConverterDelegate;
