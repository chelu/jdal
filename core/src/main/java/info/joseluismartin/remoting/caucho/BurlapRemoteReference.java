...
/**
 * Reference for BurlapProxyFactoryBean
 * 
...
public class BurlapRemoteReference extends UrlBasedRemoteReference {
	...
	public BurlapRemoteReference(BurlapProxyFactoryBean factoryBean) {
		super(factoryBean);
		this.overloadEnabled = factoryBean.isOverloadEnabled();
	}
	...
	public RemoteClient createRemoteClient() {
		...
		factoryBean.setOverloadEnabled(overloadEnabled);
